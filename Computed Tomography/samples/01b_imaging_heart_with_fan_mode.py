...
# setup a fan-mode beam array with 60 beams, each with a width of 1 pixel, spread over 60 degrees around the center
# of the image
beamArray = beam_array_fan_mode(numberOfBeams=60,
                                spreadAngle=60,
                                beamWidth=1)
...
# save the image
scannedHeart.save("CT_images_after/heart_new2.jpg")