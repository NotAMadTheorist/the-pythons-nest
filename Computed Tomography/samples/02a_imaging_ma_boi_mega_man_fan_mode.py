...
# setup a fan-mode beam array with 90 beams, each with a width of 1 pixel, spread over 90 degrees around the center
# of the image
beamArray = beam_array_fan_mode(numberOfBeams=90,
                                spreadAngle=90,
                                beamWidth=1)
...
# save the image
scannedBoi.save("CT_images_after/mega_man_new.jpg")
